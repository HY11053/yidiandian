...
class ListNewsController extends Controller
{
    ...
    public function listNews(Request $request,$path,$page=0)
    {
        ...
        if(Arctype::where('id',$typeid)->value('mid')==0)
        {
            ...
            return view('mip.index_lists',compact('thistypeinfo','pagelists','hotnew','cnewtop','cnew','cnewtops','topbrands','latestbrands','latesenews','abrandlists'));
        }elseif (Arctype::where('id',$typeid)->value('mid')==1)
        {
            ...
            return view('mip.brands',compact('thistypeinfo','pagelists','topbrands','cnewslists','hotbrands'));
        }
